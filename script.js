...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-11-28T17:01:17.194Z',
    '2022-12-01T23:36:17.929Z',
    '2022-12-02T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const displayMovements = function (acc, sort = false, date) {
...
// // Make countdown timer when program will you log out
// const dateToCountdown = new Date();
// const countdown = () => {
//   const ms = +new Date(dateToCountdown.getTime() + 0.1 * 60000) - +new Date();
//   labelTimer.textContent = new Date(ms).toISOString().slice(14, 19);
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // Create current date automaticaly using Intl
    const now = new Date();
    const options = {
      hour: 'numeric',
      minute: 'numeric',
    ...
    // taking data about language from browser
